    ...
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex-1 flex flex-col justify-center space-y-6">
        ...
        <div className="space-y-4">
          <GoogleButton className="w-full bg-muted hover:bg-muted/80 text-foreground border border-border" />
      ...
      <div className="mt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-muted-foreground lg:hidden">
        <span>Don&apos;t have an account?{" "}
          <Link className="text-foreground font-medium" href="/auth/register">Register</Link>
        </span>
