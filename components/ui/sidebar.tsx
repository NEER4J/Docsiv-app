...
function Sidebar({
  ...
  const handleMouseEnter = React.useCallback(() => {
    if (state !== "collapsed" || collapsible !== "icon" || isMobile) return
    setHoverOpen(true)
  ...
  return (
    <div
      ...
      data-state={state}
      data-collapsible={isHoverExpanded ? "" : (state === "collapsed" ? collapsible : "")}
    ...
    >
      ...
      <div
        ...
        // Keep gap at icon width when hover-expanded (don't push content)
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="right"
        align="center"
        hidden={state !== "collapsed" || isMobile || hoverOpen}
        {...tooltip}
      />
    </Tooltip>
  )
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "text-foreground pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-lg px-1 text-xs font-medium tabular-nums select-none",
